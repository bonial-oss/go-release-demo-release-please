...
# go-release-demo-release-please
...
Download for your platform from the [latest release](https://github.com/bonial-oss/go-release-demo-release-please/releases/latest):
