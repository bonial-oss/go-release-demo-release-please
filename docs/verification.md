...
Every release of `go-release-demo-release-please` is signed by
...
<https://github.com/bonial-oss/go-release-demo-release-please/releases/tag/v0.1.0>):
...
```bash
cosign verify-blob \
  --certificate-identity-regexp='^https://github.com/bonial-oss/go-release-demo-release-please/\.github/workflows/release\.yaml@refs/heads/main$' \
...
slsa-verifier verify-artifact \
  ...
  --source-uri github.com/bonial-oss/go-release-demo-release-please \
  --source-branch main \
...
```bash
git clone https://github.com/bonial-oss/go-release-demo-release-please
cd go-release-demo-release-please
git checkout v0.1.0
